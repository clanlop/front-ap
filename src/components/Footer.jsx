      ...
      <div>
        {
          ...
          ?<ul className="nav justify-content-center list-unstyled mb-3">
            ...
            <li className="ms-3"><a className="text-muted" href="https://www.instagram.com"><svg
                  xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="bi bi-instagram"
                  viewBox="0 0 16 16">
                  <path
            ...
            <li className="ms-3"><a className="text-muted" href="https://es-la.facebook.com">  <svg
                  xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="bi bi-facebook"
                  viewBox="0 0 16 16">
                  <path
